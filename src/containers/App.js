...
const emailsUrl =
  "https://gist.githubusercontent.com/OrganicPanda/17da0fa8fda252972f9753c9e9738173/raw/f7198d502f40372c99273365f5f37ab0a6c63194/emails.json";
      ...
      <div className="App">
        ...
        <Switch>
          ...
          <Route
            path="/email/:id"
            render={props => {
              return <MessagePreview data={selectedMessageId} />;
            }}
          />
